...
RSpec.describe Users::SessionsController, type: :controller do
  describe 'POST #create /users/sessions' do
    ...
    it "logs in with remember me" do
      ...
      expect(expiring_user_id_cookie[:expires]).to be_within(5.seconds).of 1.year.from_now
      expiring_person_type_cookie = stub_cookie_jar[:person_type]
      expect(expiring_person_type_cookie[:expires]).to be_within(5.seconds).of 1.year.from_now
    end
  end
