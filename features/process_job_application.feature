Feature: Accept a job application
  ...
  As a company person
  I want to process a job application
...
Background: data is added to database
  ...
  @javascript
  Scenario: company contact processes a job application
  ...
  @javascript
  Scenario: company admin processes a job application
    Given I am on the home page
    ...
    Then I process "june@ymail.com" application for "hr assistant"
    And I should see an "process" confirmation
    Then I click the "Process" confirmation
    And I wait 1 second
    And I should see "june@ymail.com" application for "hr assistant" changes to Processing
