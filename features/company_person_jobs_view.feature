Feature: Company Person Jobs View
  ...
  Background:
    ...
    Given the following jobs exist:
      ...
      | software dev | KRK01K          | Evening| true     | internship | Widgets Inc. | carter@ymail.com |
      | Cook         | KRK11K          | Evening| true     | internship | Feature Inc. | ca@feature.com   |
      | Doctor       | AAEE1K          | Evening| true     | internship | Feature Inc. | ca@feature.com   |
